...
import bgimage from '../Assets/helena-lopes-e3OUQGT9bWU-unsplash.jpg';
...
const LifeForm: React.FC = () =>{
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        const response = await axios.post('http://localhost:5001/submit-life', formData);
        ...
        <div className="p-10 bg-white bg-opacity-90 rounded-lg shadow-md max-w-7xl mx-auto mt-28 h-2/4">
          ...
          <form className="flex flex-row gap-10 flex-wrap justify-between" onSubmit={handleSubmit}>
            ...
            <div className="flex-grow" id="right-column-items">
              <div className="mb-4">
                <label className="block text-gray-700 text-lg mb-2" htmlFor="coverageType">Type of Coverage</label>
                <input 
                  type="text" 
                  name="coverageType" 
                  ...
                  onChange={handleChange} 
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
                  placeholder="Enter the type of coverage"
                  required
                />
              </div>
              ...
              <div className="mb-6">
                <label className="block text-gray-700 text-lg mb-2" htmlFor="beneficiary">Beneficiary Name</label>
                <input    
                  type="text" 
                  name="beneficiary" 
