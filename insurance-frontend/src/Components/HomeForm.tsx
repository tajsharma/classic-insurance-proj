...
import bgimage from '../Assets/daniel-chen-SoNaNOFT974-unsplash.jpg';
      ...
      >
        <div className="p-10 bg-white bg-opacity-90 rounded-lg shadow-md max-w-7xl mx-auto mt-28 h-2/4">
          ...
          <form className="flex flex-row gap-10 flex-wrap justify-between" onSubmit={handleSubmit}>
            <div id="left-column-items"className="flex-grow">
              <div className="mb-4">
            ...
            <div id="right-column-items"className="flex-grow">
              <div className="mb-4">
