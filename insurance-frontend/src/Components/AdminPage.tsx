    ...
    return (
        <div className="bg-orange-200 h-screen">
            <div className="pt-28 px-5 gap-5 flex justify-end items-center">
                <button className="bg-orange-400 text-blue-900 font-bold py-2 px-4 rounded-lg hover:text-white transition duration-200">
                    Employee Profile
                </button>
                <button
            ...
            <div className="pt-3 p-5">
                ...
                <div id="buttons" className="py-4 pb-5 flex justify-around">
                    <button onClick={() => setEndpoint('/admin/auto-data')} className="bg-blue-800 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded shadow transition-all duration-200">Auto Insurance</button>
                    <button onClick={() => setEndpoint('/admin/home-data')} className="bg-blue-800 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded shadow transition-all duration-200">Home Insurance</button>
                    <button onClick={() => setEndpoint('/admin/life-data')} className="bg-blue-800 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded shadow transition-all duration-200">Life Insurance</button>
                    <button onClick={() => setEndpoint('/admin/business-data')} className="bg-blue-800 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded shadow transition-all duration-200">Business Insurance</button>
                    <button onClick={() => setEndpoint('/admin/flagged-clients')} className="bg-blue-800 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded shadow transition-all duration-200">View Flagged Clients</button>
                </div>
